...
Notable changes to `deki-uart`. Engine and editor changes are in the
...
### Changed
- **Moved into the `DekiUart` namespace.** Every component was declared at global
  ...
  Code naming these types needs the namespace: `using namespace DekiUart;` or a
  qualified name.
